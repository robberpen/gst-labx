...
$GSTAPP \
$qmmfsrc0     ! $NV_1080P30 ! $mix0 ! queue ! $overlay    ! $NV_1080P30 ! $omx264 ! $rtsp \
qmmf0.video_1 ! $NV_1080P30 ! $mix1 ! queue ! $overlay    ! $NV_1080P30 ! $(TransForm1080P "CAP0") ! qtijpegenc ! fakesink \
