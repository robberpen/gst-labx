...
# 221124 update 1124_oom_seg_perf, Aver use this as criteria, script from Aver fail log 1128_gst_hang.7z
#
$GSTAPP \
$qmmfsrc0     ! $(CAPS_1080P "CAP0")  ! queue ! qtivtransform ! $omx264 ! $CAPS_omx264 ! h264parse config-interval=-1 ! fakesink \
...
$qmmfsrc1     ! $NV_1080P30 ! mix2. \
qmmf1.video_2 ! $NV_1080P30 ! queue ! $TRANSFORM_FLIP ! $overlay ! $YUV_TRANS \
