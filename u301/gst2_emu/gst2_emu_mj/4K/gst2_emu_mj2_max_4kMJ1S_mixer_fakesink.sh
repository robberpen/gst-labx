...
# based from gst2_emu_mj2_max_4kMJ1S_mixer264.sh remove omx264
# 221114-gst2_emu_mj2_max_4kMJ1S_mixer_fakeink.sh-267r-chgfail
# 221114 1440r pass
$GSTAPP \
$qmmfsrc0 ! $(CAPS_1080P "CAP0") ! $mix1 ! queue ! $overlay   ! $(CAPS_1080P "CAP1") ! fakesink \
